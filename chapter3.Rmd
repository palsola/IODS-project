...
g1_1 <- g1 + geom_boxplot() + ylab("grade") + ggtitle("Family relationships by alcohol \n consumption and sex")

# a plot of high_use and absences by sex
g2 <- ggplot(alc, aes(x = high_use, y = absences, colour= sex))
g2_1 <- g2 + geom_boxplot() + ylab("grade") + ggtitle("Student absences by alcohol \n consumption and sex")

# a plot of high_use and health by sex
g3 <- ggplot(alc, aes(x = high_use, y = health, colour= sex))
g3_1 <- g3 + geom_boxplot() + ylab("grade") + ggtitle("Health by alcohol consumption \n and sex")
...
library(gridExtra)
grid.arrange(g1_1, g2_1, g3_1, ncol=2)
...
The average number of wrong predictions in the cross validation is `r wrong_pred` which is slightly better than the model introduced in DataCamp (which had about 0.26 error).
